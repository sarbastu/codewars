...
In honor of my grandfather's memory we will write a function using 
his formula!
...
function predictAge(age1, age2, age3, age4, age5, age6, age7, age8) {
  const sum = [...arguments].map((age) => age * age).reduce((a, b) => a + b);
  const dividedSquareRoot = Math.sqrt(sum) / 2;
  return Math.floor(dividedSquareRoot);
}
/* ===============================================
