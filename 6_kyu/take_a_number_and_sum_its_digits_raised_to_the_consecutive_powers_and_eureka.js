...
and outputs a list of the sorted numbers in the range that fulfills the 
...
If there are no numbers of this kind in the range the function should 
...
function sumDigPow(a, b) {
  ...
  for (let i = a; i <= b; i++) {
    let test = String(i)
      .split('')
      .reduce((a, e, i) => (a += e ** (i + 1)), 0);
    if (i === test) res.push(i);
  }
  return res;
}
